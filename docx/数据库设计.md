...
**标签分类**：intensity（活动强度）、theme（主题）、cuisine（菜系）、mood（情绪）
...
-- 数据初始化 - 标签表
-- ============================================
INSERT INTO tag_info (tag_code, tag_name, category) VALUES
('historical', '{"zh": "历史建筑", "en": "Historical Buildings"}', 'theme'),
('nature', '{"zh": "自然风光", "en": "Natural Scenery"}', 'theme'),
('food', '{"zh": "美食探店", "en": "Food & Dining"}', 'cuisine'),
('coffee', '{"zh": "咖啡文化", "en": "Coffee Culture"}', 'cuisine'),
('art', '{"zh": "艺术展览", "en": "Art Exhibitions"}', 'theme'),
('shopping', '{"zh": "购物娱乐", "en": "Shopping & Entertainment"}', 'theme'),
('nightlife', '{"zh": "夜生活", "en": "Nightlife"}', 'mood'),
('family', '{"zh": "亲子游", "en": "Family Travel"}', 'intensity'),
('culture', '{"zh": "文化遗产", "en": "Cultural Heritage"}', 'theme'),
('leisure', '{"zh": "休闲漫步", "en": "Leisure Walk"}', 'intensity'),
('explorer', '{"zh": "暴走特种兵", "en": "Active Explorer"}', 'intensity'),
('intimate', '{"zh": "深度体验", "en": "In-depth Experience"}', 'intensity');
...
以下为 Prisma Schema 示例，定义了所有26张表的模型结构：
